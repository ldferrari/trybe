//Construa um array de objetos a partir do array de livros. Cada objeto deve conter uma propriedade 
...
function nameAndAge() {
  ...
  const autor = books.map((book) => ({
    author: book.author.name,
    age: book.releaseYear - book.author.birthYear
  }))
  
  const oredem = autor.sort((a, b) => (a.age - b.age));
  return oredem
}
